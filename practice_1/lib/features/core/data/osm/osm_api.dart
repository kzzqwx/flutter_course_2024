...
class OSMApi {
  ...
  Future<OSMWeather> getWeatherByCoords(double lat, double lon) async {
    var response = await http.get(Uri.parse('$url/data/2.5/weather?lat=$lat&lon=$lon&appid=$apiKey'));
    var rJson = jsonDecode(response.body);
